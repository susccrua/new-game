...
This version of FPS Microgame is officially compatible with Unity 2018.4. In order to fix the
project for Unity 2019, please go to "Window" > "Package Manager" and
- select "Package Manager UI", and
